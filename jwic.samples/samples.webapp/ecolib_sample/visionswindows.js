...
var Visions = {	
	...
	openPrototypeWindow : function(serverRefId, winName, winTitle, height, width, isModal) {
		if (height == undefined) 
			height = 100;
		...
		try {
			...
			var wWin = new Window(winName, {className: 'mac_os_x', zIndex:100, width: width, height: height, 
											title: winTitle, parent: $(winName + '_container') });
...
Visions.WindowObserver = Class.create();


Visions.WindowObserver.prototype = {
	initialize : function() {
	},
...
///////////////////////////////////////////////////////
/// Thanks to http://prototype-window.xilinus.com/  ///
///////////////////////////////////////////////////////
...
Window.prototype = {
	...
	initialize: function(id) {
	  if ($(id))
		...
		this.hasEffectLib = false;//String.prototype.parseColor != null;
	...
	this.serverid = id;                      // added for Visions
 	...
 	disableScreen: function(className, overlayId, contentId) {
		...
		if (contentId && isIE) {
      		$$('select').each(function(element) {
      			if(element.parentNode.getAttribute("id").indexOf("pop")==-1){
