 ...
 * $Id: HtmlEditorDemo.java,v 1.4 2010/02/07 14:26:33 lordsam Exp $
 */
...
import de.jwic.ecolib.controls.htmleditor.HtmlEditorControl;
 ...
 */
public class HtmlEditorDemo extends ControlContainer {
	 ...
	 * @param container
	 */
	public HtmlEditorDemo(IControlContainer container) {
		super(container);
		
		
		editor = new HtmlEditorControl(this, "editor");
		...
		btPreview.addSelectionListener(new SelectionListener() {
			public void objectSelected(SelectionEvent event) {
				lblPreview.setText(editor.getHTML());
			};
