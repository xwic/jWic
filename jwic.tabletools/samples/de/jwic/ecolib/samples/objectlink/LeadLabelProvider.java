 ...
 *
 * de.jwic.ecolib.samples.objectlink.LeadLabelProvider
 * Created on 12.04.2007
 * $Id: LeadLabelProvider.java,v 1.1 2007/04/25 09:59:15 lordsam Exp $
 */
 ...
 */
public class LeadLabelProvider implements ITableLabelProvider {
	...
	public CellLabel getCellLabel(Object row, TableColumn column, RowContext context) {
		...
		case 0: 
			return new CellLabel(lead.id);
		case 1:
			return new CellLabel(lead.name);
		case 2: 
			return new CellLabel(lead.area);
		case 3:
			return new CellLabel(df.format(lead.firstContact)); 
		}
		return null;
	}
