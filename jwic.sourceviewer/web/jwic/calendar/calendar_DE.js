...
// 	modified by Florian Lippisch on 25 Sep 2002: changed so it runs on foreign frames
	...
	var weekString = "KW"
	var scrollLeftMessage = "Hier klicken um zum vorherigen Monat zu scrollen. Maustasten gedr&uuml;ckt halten, um automatisch zu scrollen."
	var scrollRightMessage = "Hier klicken um zum n&auml;chsten Monat zu scrollen. Maustasten gedr&uuml;ckt halten, um automatisch zu scrollen."
	var selectMonthMessage = "Hier klicken um einen Monat auszuw&auml;hlen."
	var selectYearMessage = "Hier klicken um ein Jahr auszuw&auml;hlen."
	var selectDateMessage = "[date] als Datum &uuml;bernehmen." // do not replace [date], it will be replaced by date.
   ...
   function WeekNbr(n) {
	...
	function initLib(newDocument) {
		...
		addHoliday(24,12,0, "Heiliger Abend");
		addHoliday(25,12,0, "Weihnachten");
		addHoliday(26,12,0, "Weihnachten");
		addHoliday(31,12,0, "Silvester");
