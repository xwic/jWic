...
/**
 * Stellt eine empfängene Datei der Upload-Klasse da.
 * 
...
/**
 * UploadFile - Stellt eine empfängene Datei der Upload-Klasse da.
 */
public UploadFile() {
	super();
}
/**
 * Räumt das Object weg und eine eventuell erstellte Tmp-Datei.
 ...
 * Wurde kein Dateiname angegeben, wird dieser aus dem Servlet-InputStream übernommen.
 * Existiert eine Datei oder ein Verzeichniss unter dem Namen schon, wird ein "(1...x)" angehängt.
 * Erstellungsdatum: (29.01.2002 09:11:25)
 * Rückgabe die geschriebenen Bytes, oder -1 wenn Verbindung zum Client verloren ging
 * @return int
 */
