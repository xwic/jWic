...
public ContentParser(HttpServletRequest req, long maxSize) throws IOException {
	...
	// Überprüfe Inhalt auf enctype="multipart/form-data"
	...
	// Wenn keiner von beiden NULL ist, den längeren nehmen.
	...
	// Überprüfen der Größe des Inhaltes.
	...
	// Ergebnis überprüfen ob boundary = Erstezeile
...
/**
 * Gibt die Inhaltsangaben zurück
 * Erstellungsdatum: (08.03.01 19:41:46)
 * @param line java.lang.String
 */   
...
/**
 * Gibt den nächsten Inhalt / Feld zurück
 * Erstellungsdatum: (08.03.01 19:41:46)
