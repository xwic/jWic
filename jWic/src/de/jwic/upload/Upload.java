...
public class Upload {
	 ...
	 * @param maxPostSize int max. Dateigröße für die ein Upload getätigt werden soll.
	 ...
	 * Standard Upload
	 * @param req javax.servlet.http.HttpServletRequest
	 * @param sDirSave java.lang.String Temporäres Arbeitsverzeichnis
	 * @param maxPostSize int max. Dateigröße für die ein Upload getätigt werden soll.
	 * @param memoryUsage int max. Speichernutzung, bei überschreiten wird eine temp. Datei erstellt
	 * @exception java.io.IOException
	 */
	...
	public Upload(HttpServletRequest req, String sDirSave, long maxPostSize, int memoryUsage) throws IOException {
		...
		// Überprüfen ob File ein Directory ist
		if (!fDir.isDirectory()) fDir.mkdirs();
	
		// Überprüfen ob in Directory geschrieben werden kann
		if (!fDir.canWrite())
		...
		//HashMap für Felder und Inhalt definieren
	 ...
	 * gewesen sein sollen, dann können Sie über diese Methode auf die Felder
	...
	/**
	 * Gibt die parameter zurück welche nicht als Felder eingelesen wurden.
	 */
