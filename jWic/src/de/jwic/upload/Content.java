...
/**
 * Repräsentiert den Inhalt der Multipart / from-data
 */
...
/**
 * Repräsentiert den Inhalt der Multipart / form-data
 * Erstellungsdatum: (08.03.01 09:01:38)
 * @param in javax.servlet.ServletInputStream
 * @param boundary java.lang.String Grenzlinie. Zeigt den Anfang des nächsten Feldes an
...
/**
 * Datei bis zur nächsten Grenzlinie einlesen
 * @exception java.io.IOException
 */
...
public boolean isFile() {
 ...
 /**
  * Daten Zeile für Zeile, Byte für Byte auslesen.
  * @exception java.io.IOException
  */ 
