...
import de.jwic.demo.chart.DoughnutChartDemoModule;
import de.jwic.demo.chart.LineChartDemoModule;
import de.jwic.demo.chart.PieChartDemoModule;
...
public class DemoApplication extends Application {
	...
	public Control createRootControl(IControlContainer container) {
		...
		modules.add(new DoughnutChartDemoModule());
		modules.add(new PieChartDemoModule());
