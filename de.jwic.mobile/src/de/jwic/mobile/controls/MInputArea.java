 ...
 */
@JavaScriptSupport(jsTemplate = "de.jwic.mobile.controls.MInputBox")
public class MInputArea extends MInputBox {
	private int rows = 8;
	 ...
	 * @param name
	 */
	public MInputArea(IControlContainer container, String name) {
