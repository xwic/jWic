...
import de.jwic.mobile.common.blurable.BlurHandler;
 ...
 */
@JavaScriptSupport
public class TextInput extends Control implements WithTextProperty, PropertyObservable, Visible, Blurable, Enableable {
	 ...
	 * @param name
	 */
	public TextInput(IControlContainer container, String name) {
		super(container, name);
		this.blurHandler = new BlurHandler<TextInput>(this);
