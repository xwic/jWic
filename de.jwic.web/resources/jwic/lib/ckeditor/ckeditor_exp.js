...
(function() {
    ...
    (function() {
        function m(n, o) {
            var p = n.createFakeParserElement(o, 'cke_iframe', 'iframe', true),
                q = p.attributes.style || '',
                r = o.attributes.width,
                s = o.attributes.height;
            ...
            arrayToList: function(E, F, G, H, I) {
                ...
                while (1) {
                    ...
                    if (R.indent == N) {
                        ...
                        var T = R.element.getDirection(1),
                            U = E[M - 1].element.getDirection(1),
                            V = j.list.arrayToList(E, null, M, H, U != T ? T : null);
    ...
    j.pagebreakCmd = {
        exec: function(m) {
            var n = m.lang.pagebreakAlt,
                o = h.createFromHtml('<div style="page-break-after: always;"contenteditable="false" title="' + n + '" ' + 'aria-label="' + n + '" ' + 'data-cke-display-name="pagebreak" ' + 'class="cke_pagebreak">' + '</div>'),
    ...
    (function() {
        ...
        function q(G) {
            if (G instanceof d.selection) {
                ...
                var X = J.$.rows,
                    Y = new h(X[M] || X[M - 1] || J.$.parentNode);
